...
class SignUpPsycho extends StatefulWidget {
  static String route = "CreateAccount";

  const SignUpPsycho({Key? key}) : super(key: key);

  @override
  State<SignUpPsycho> createState() => _SignUpPsychoState();
}

class _SignUpPsychoState extends State<SignUpPsycho> {
